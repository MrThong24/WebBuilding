...
export const dataCaiTaoSuaChuaCongTrinh: AboutListChild[] = [
  { title: "Sửa chữa, bảo dưỡng hệ thống điều hoà, không khí", des: "Cung cấp dịch vụ sửa chữa và bảo dưỡng hệ điều hòa không khí, giúp tối ưu hiệu suất làm lạnh và tiết kiệm năng lượng. Ngoài ra, dịch vụ còn xử lý các vấn đề liên quan đến mùi hôi và chất lượng không khí trong nhà, đảm bảo không gian sống luôn trong lành và thoải mái. Cam kết khắc phục nhanh chóng các sự cố và thực hiện bảo trì định kỳ để hệ thống hoạt động ổn định, bền lâu và duy trì môi trường sống tối ưu cho gia đình bạn",slug: "cai-tao-cong-trinh",icon: ThiCong },
  { title: "Sửa chữa điện nước", des: "Dịch vụ sửa chữa điện nước bao gồm cải tạo và lắp đặt hệ thống an ninh, giúp bảo vệ an toàn cho ngôi nhà. Chuyên sửa chữa hệ thống điện, khắc phục sự cố và nâng cấp các thiết bị điện. Bên cạnh đó, dịch vụ cũng lắp đặt và sửa chữa hệ thống thông minh trong nhà, nâng cao tiện nghi và hiện đại hóa không gian sống. Ngoài ra, còn có dịch vụ thông cống, xử lý tắc nghẽn các đường ống, cùng với sửa chữa hệ thống đường ống nước, van, bồn cầu và vòi sen, đảm bảo hệ thống hoạt động ổn định và thuận tiện cho sinh hoạt hàng ngày.",slug: "cai-tao-cong-trinh",icon: ThiCong },
  { title: "Chống thấm và xử lý độ ẩm", des: "Đưa ra các giải pháp chống thấm toàn diện, bảo vệ công trình khỏi sự tấn công của nước, độ ẩm và mưa. Với quy trình kiểm tra kỹ lưỡng, phát hiện chính xác các điểm yếu, chúng tôi thực hiện xử lý triệt để các khu vực dễ bị thấm dột, giúp công trình luôn khô ráo, bền bỉ và duy trì độ bền lâu dài.",slug: "cai-tao-cong-trinh",icon: ThiCong },
  { title: "Cải tạo mặt tiền, nội thất, ngoại thất và cảnh quan", des: "Cải tạo toàn diện là phương châm của Đại Tiến Phát Group, bao gồm tân trang bề mặt tường, sàn, và nâng cấp thiết bị nội thất để tạo ra không gian sống mới mẻ, hiện đại và tiện nghi. Dịch vụ còn bao gồm việc sơn sửa tường ngoài, thay cửa, cổng, giúp công trình trở nên khang trang và bắt mắt hơn. Đồng thời, cải tạo sân vườn và lối đi sẽ mang lại không gian ngoại thất đẹp mắt, hài hòa, nâng cao giá trị thẩm mỹ và công năng cho ngôi nhà của bạn..",slug: "cai-tao-cong-trinh",icon: ThiCong },
  ...
  { title: "Cải tạo công trình phụ", des: "Đại Tiến Phát Group chuyên cung cấp các giải pháp thi công và hoàn thiện công trình phụ với chất lượng vượt trội. Từ nhà vệ sinh, nhà tắm đến các khu vực tiện ích khác, chúng tôi cam kết mang lại sự tiện nghi, bền bỉ và thẩm mỹ cao cho mọi dự án. Với kinh nghiệm lâu năm và đội ngũ thi công chuyên nghiệp, Đại Tiến Phát luôn đảm bảo tiến độ và chất lượng, đáp ứng mọi yêu cầu khắt khe của khách hàng." ,slug: "cai-tao-cong-trinh",icon: ThiCong},
];
export const dataCongTrinhNhaThep: AboutListChild[] = [
  { title: "Thi công nhà thép cho nhà xưởng, kho bãi", des: "Đề xuất giải pháp tối ưu về kết cấu và không gian sử dụng. Với kỹ thuật thi công chính xác, các công trình của chúng tôi đảm bảo tính bền vững, an toàn và hiệu quả chi phí. Phù hợp với nhu cầu lưu trữ và sản xuất của doanh nghiệp.", slug: "cong-trinh-nha-thep",icon: NhaThep },
