  ...
  const posts = [
    {
      id: 1,
      title: "Chất lượng",
      description: "Chúng tôi cam kết cung cấp sản phẩm và dịch vụ chất lượng cao nhất, đảm bảo sự hài lòng của khách hàng."
    },
    {
      id: 2,
      title: "Đổi mới",
      description: "Chúng tôi luôn tìm kiếm những giải pháp sáng tạo và công nghệ tiên tiến để cải thiện quy trình và sản phẩm của mình."
    },
    {
      id: 3,
      title: "Tin cậy",
      description: "Khách hàng có thể hoàn toàn yên tâm khi hợp tác với chúng tôi, vì chúng tôi luôn giữ đúng lời hứa và cam kết."
    },
    {
      id: 4,
      title: "Bền vững",
      description: "Chúng tôi chú trọng đến việc bảo vệ môi trường và phát triển bền vững trong mọi hoạt động của mình."
    },
    {
      id: 5,
      title: "Đội ngũ chuyên nghiệp",
      description: "Đội ngũ nhân viên của chúng tôi là những chuyên gia giàu kinh nghiệm, luôn sẵn sàng hỗ trợ và tư vấn cho khách hàng."
    },
    {
      id: 6,
      title: "Khách hàng là trung tâm",
      description: "Chúng tôi đặt khách hàng lên hàng đầu, lắng nghe và đáp ứng nhu cầu của họ để tạo ra giá trị tốt nhất."
    }
  ];
  return (
    <div>
